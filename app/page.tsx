          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-6 text-base md:space-y-8 md:text-lg">
              <p>
                ...
                комфортабельные домики, оформленные в скандинавском стиле,
                которые смогут удовлетворить потребности любого постояльца.
              </p>
              <p>
              ...
              <p>
                ...
                природы. Это место, где можно замедлиться, расслабиться и
                ощутить радость быть вместе в красивой обстановке.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-6 text-base md:space-y-8 md:text-lg">
              <p>
                ...
                рай, основанный нашими бабушкой и дедушкой, создавался с любовью
                и заботой и передавался через всю нашу семью как свидетельство
                нашего стремления создать теплую, гостеприимную атмосферу.
              </p>
              <p>
                Отдыхая в наших домиках, вы ощущаете и комфорт городской
                квартиры, и волшебство нетронутой природы. Это идеальный
                вариант, чтобы уйти от шумного мегаполиса, освободить голову от
                суеты и мыслей или побыть наедине с любимым человеком.
              </p>
